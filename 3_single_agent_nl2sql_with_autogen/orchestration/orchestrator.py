...
class Orchestrator:
    ...
    def answer(self,history, ask: str) -> dict:
        ...
        answer_dict = self._initiate_group_chat(agents, ask)
        return answer_dict
    ...
    def _initiate_group_chat(self, agents: list, ask: str) -> dict:
    ...
    def _setup_llm_config(self):
        """Set up the configuration forOpenAI language model."""
        self.llm_config = {
            "config_list": [
                {
